            ...
            (function (Skia) {
                class ImageLoader {
                    ...
                    static imageToBytes(img) {
                        ...
                        const imageData = ImageLoader.ctx.getImageData(0, 0, ImageLoader.canvas.width, ImageLoader.canvas.height);
                ...
                ImageLoader.canvas = document.createElement('canvas');
                ImageLoader.ctx = ImageLoader.canvas.getContext("2d", { willReadFrequently: true });
